...
import pytest
import time
from soft_hertz_tool.devices.kaudc004a.protocol import build_frame, parse_response, crc16_ccitt
from soft_hertz_tool.devices.afdtr1024.protocol import (
...
class TestKaUDC004AProtocol:
    ...
    def test_kaudc_build_version_query(self):
        """测试版本回读命令构建"""
        from soft_hertz_tool.devices.kaudc004a.protocol import build_version_query_frame, CMD_VERSION
    ...
    def test_kaudc_build_temperature_query(self):
        """测试温度查询命令构建"""
        from soft_hertz_tool.devices.kaudc004a.protocol import build_temp_query_frame, CMD_TEMP_QUERY
    ...
    def test_kaudc_build_tx_lo_setting(self):
        ...
        from soft_hertz_tool.devices.kaudc004a.protocol import build_tx_lo_frame, CMD_TX_LO
    ...
    def test_kaudc_build_rx_lo_setting(self):
        ...
        from soft_hertz_tool.devices.kaudc004a.protocol import build_rx_lo_frame, CMD_RX_LO
    ...
    def test_kaudc_build_tx_atten_setting(self):
        ...
        from soft_hertz_tool.devices.kaudc004a.protocol import build_tx_att_frame, CMD_TX_ATT, ATT_MIN, ATT_MAX
    ...
    def test_kaudc_build_rx_atten_setting(self):
        ...
        from soft_hertz_tool.devices.kaudc004a.protocol import build_rx_att_frame, CMD_RX_ATT
    ...
    def test_kaudc_parse_temperature_response(self):
        """测试温度响应解析"""
        from soft_hertz_tool.devices.kaudc004a.protocol import crc16_ccitt, parse_response, CMD_TEMP_QUERY
    ...
    def test_kaudc_parse_lo_query_response(self):
        """测试本振查询响应解析"""
        from soft_hertz_tool.devices.kaudc004a.protocol import crc16_ccitt, parse_response, CMD_LO_QUERY
    ...
    def test_kaudc_parse_atten_query_response(self):
        """测试衰减查询响应解析"""
        from soft_hertz_tool.devices.kaudc004a.protocol import crc16_ccitt, parse_response, CMD_ATT_QUERY
...
class TestMultiSubarray:
    ...
    def test_sim_tx_status_per_id(self):
        ...
        from soft_hertz_tool.devices.afdtr1024.simulator import TXSimulator
    ...
    def test_sim_rx_status_per_id(self):
        ...
        from soft_hertz_tool.devices.afdtr1024.simulator import RXSimulator
